...
class EmployeeController extends AbstractController
{
    ...
    /**
     * @Route(path="/weekly-schedules", methods={"GET"}, name="app.admin.api.employees.get_schedule_list")
     * @OA\Get(
     *     tags={"Админка. Управление сотрудниками"},
     ...
     * @throws ApiException
     */
    public function scheduleAction(Request $request, EmployeeManager $manager): JsonResponse
    {
        $filters = $request->query->all();
        try {
