...
{
    /**
     * @Route(path="", methods={"GET"}, name="app.api.areas.get_list")
     * @OA\Get(
     *     tags={"Фронт. Управление регионами"},
    ...
    /**
     * @Route(path="/{id}", methods={"GET"}, name="app.api.areas.get_details")
     * @OA\Get(
     *     tags={"Фронт. Управление регионами"},
     *     summary="Данные регионов",
