...
class PriceChange
{
    ...
    /**
     * @var StockChange|null
     * @ORM\OneToOne(targetEntity="StockChange", mappedBy="priceChange")
     * @ORM\JoinColumn(name="stock_change_id", referencedColumnName="id", nullable=true)
     */
